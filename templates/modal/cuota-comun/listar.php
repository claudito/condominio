...
CuotaComun::agregar($periodo);
 ?>

 <?php if (count(CuotaComun::lista($periodo))>0): ?>
 <div class="panel panel-primary">
 	...
 	<table class="table table-condensed">
 		...
 		<tbody>
 		<?php foreach (CuotaComun::lista($periodo) as $key => $value): ?>
		<tr>
  ...
  <script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.get("../templates/modal/cuota-comun/actualizar.php","id="+id,function(data){
  			$("#form-edit").html(data);
  		});
